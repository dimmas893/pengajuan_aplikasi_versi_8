...
class ApprovalController extends Controller
{
    ...
    public function data_admin_barang_belum_approve()
    {
        ...
        if ($emps->count() > 0) {
            $output .=
                '<table class="table" table-striped table-sm text-center align-middle width="100%" cellspacing="0">
            ...
            foreach ($emps as $emp) {
                ...
                <td>
                <a href="/approval/approve_admin_detail/' . $emp->id . '" class="btn btn-info"><i class="fa-solid fa-eye"></i></a>
                <a href="/pengajuan_detail/delete_pengajuan/' . $emp->id . '" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
              </tr>';
            }
            $output .= '</tbody></table>';
        ...
        if ($emps->count() > 0) {
            ...
            foreach ($emps as $emp) {
                ...
                <td>' . 'Rp' . '  ' . number_format($emp->total_biaya, 2, ',', '.') . '</td>
                  <td><p style="color:chartreuse">Approve</p> </td>
                <td>
                <a href="/approval/super_admin_detail/' . $emp->id . '" class="btn btn-info"><i class="fa-solid fa-eye"></i></a>
                </td>
              </tr>';
            }
            $output .= '</tbody></table>';
        ...
        if ($emps->count() > 0) {
            ...
            foreach ($emps as $emp) {
                ...
                <td>' . 'Rp' . '  ' . number_format($emp->total_biaya, 2, ',', '.') . '</td>
                  <td><p style="color:red">Masih Diperiksa</p> </td>
                <td>
                <a href="/approval/super_super_admin_detail/' . $emp->id . '" class="btn btn-info"><i class="fa-solid fa-eye"></i></a>
                <a href="/pengajuan_detail/delete_pengajuan/' . $emp->id . '" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
              </tr>';
            }
        ...
        if ($emps->count() > 0) {
            ...
            foreach ($emps as $emp) {
                ...
                <td>' . 'Rp' . '  ' . number_format($emp->total_biaya, 2, ',', '.') . '</td>
                  <td><p style="color:red">Masih Diperiksa</p> </td>
                <td>
                <a href="/approval/detail/' . $emp->id . '" class="btn btn-info"><i class="fa-solid fa-eye"></i></a>
                <a href="/pengajuan_detail/delete_pengajuan/' . $emp->id . '" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
              </tr>';
            }

...
Route::get('/approval/data_user_barang_approve', [ApprovalController::class, 'data_user_barang_approve']);
Route::get('/approval/data_user_barang_belum_approve', [ApprovalController::class, 'data_user_barang_belum_approve']);

Route::get('/approval/data_admin_barang_approve', [ApprovalController::class, 'data_admin_barang_approve']);
Route::get('/approval/data_admin_barang_belum_approve', [ApprovalController::class, 'data_admin_barang_belum_approve']);

Route::get('/approval/data_level_2_barang_belum_approve', [ApprovalController::class, 'data_level_2_barang_belum_approve']);
Route::get('/approval/data_level_2_barang_approve', [ApprovalController::class, 'data_level_2_barang_approve']);

Route::get('/approval/data_level_3_barang_approve', [ApprovalController::class, 'data_level_3_barang_approve']);
Route::get('/approval/data_level_3_barang_belum_approve', [ApprovalController::class, 'data_level_3_barang_belum_approve']);




Route::get('/approval/admin', [ApprovalController::class, 'admin']);
Route::get('/approval/notiv/user', [ApprovalController::class, 'notiv_user']);

...
$superadmin = \App\Models\User::where('id', Auth::user()->id)->where('role', 'superadmin')->first();  
                ...
                <div class="row w-auto">
                      <div class="col-12">
                          @if($pengajuan->level_3 == null)
                                <form action="/keranjang/store_approve"  method="post">
                                  @csrf
                            ...
                            <div class="card-header">Action</div>
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-6">
                                      ...
                                      @if($pengajuan->level_3 == null)
                                          ...
                                          {{-- <p>Rp {{ number_format($pengajuan->total_biaya,2,',','.') }}</p> --}}
                                              <form action="/approval/approve_supersuperadmin" method="post">
                                                  @csrf
                                  ...
                                  <div class="col-6">
                                      <a href="/approval/notiv/level_3" class="btn btn-primary">Back</a>
                                  </div>
                                </div>
                            </div>
                        </div>
